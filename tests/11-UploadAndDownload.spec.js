...
//writeExcelTest("Mango",350,{rowChange:0,colChange:2},"/Users/onurcelik/Downloads/download.xlsx");
...
test('Upload download excel validation', async ({ page }) => {
  ...
  const filePath = '/Users/onurcelik/Downloads/download.xlsx'; // or await dl.path()
